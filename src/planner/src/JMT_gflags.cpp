...
DEFINE_double(ratio_safe_dis, 3.6, "Ratio between safe distance and current speed");

DEFINE_double(radius_safe_dis, 1.5, "Radius of car");
...
// smoother
DEFINE_int32(clothoide_n_lookahead, 8,
"Points lookahead used to smooth.");
//DEFINE_double(clothoide_n_lookahead, 2.0,
//"Interval length.");
...
DEFINE_double(force_route_dis, 50.0,
              "Distance when force car to drive on main route");
DEFINE_double(longitudinal_jerk_upper_bound, 4.0,
              "The upper bound of longitudinal jerk.");

// weight
DEFINE_double(weight_static_collision, 1000.0, "Weight of collision on static obstacle");
DEFINE_double(weight_lon_objective, 20, "Weight of longitudinal travel cost");
DEFINE_double(weight_lon_jerk, 1.0, "Weight of longitudinal jerk cost");
DEFINE_double(weight_lon_collision, 1000.0,
              "Weight of logitudinal collision cost");
DEFINE_double(weight_lat_offset, 0.0, "Weight of lateral offset cost");
DEFINE_double(weight_route_offset, 10.0, "Weight of lateral offset cost");
DEFINE_double(weight_lat_comfort, 1.0, "Weight of lateral comfort cost");
DEFINE_double(weight_centripetal_acceleration, 1.5,
              "Weight of centripetal acceleration");
DEFINE_double(weight_consistency, 25.0,
              "Weight of consistency");
DEFINE_double(weight_change_distance, 20.0,
              "Weight of change distance");
